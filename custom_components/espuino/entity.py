...
from .const import DOMAIN, CONF_DEVICE_NAME, CONF_FRIENDLY_NAME, DEFAULT_MQTT_BASE_TOPIC, DEFAULT_MQTT_STATE_TOPIC, STATE_SUFFIX_ONLINE_STATE, PAYLOAD_ONLINE, PAYLOAD_OFFLINE
...
class EspuinoMqttEntity(Entity):
    ...
    def _get_full_state_topic(self, state_topic_suffix_const: str) -> str:
        ...
        return f"{self._device_name}/{DEFAULT_MQTT_STATE_TOPIC}/{state_topic_suffix_const}"
    ...
    def _get_full_command_topic(self, command_topic_suffix_const: str) -> str:
        ...
        return f"{self._device_name}/{DEFAULT_MQTT_BASE_TOPIC}/{command_topic_suffix_const}"
